...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        LT(SYMB,FR_UGRV), FR_LESS,     LSFT(KC_LALT), KC_LEFT, KC_RGHT,
        ...
        GUI_T(KC_ESCAPE), KC_N,    FR_COMM,     LT(MDIA, FR_SCLN), FR_COLN, RCTL_T(FR_EQL),   KC_RSFT,
...
[SYMB] = LAYOUT_ergodox(
    ...
    KC_TRNS,   FR_BSLS,  KC_KP_ASTERISK,  FR_DLR,         FR_LCBR,        FR_RCBR,  TT(MDIA),
